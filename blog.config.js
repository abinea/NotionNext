...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'fb14fbddb4de4c1887ba65fd40977c57',
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20240819号', // 备案号 闽ICP备XXXXXXX
  ...
  PRISM_THEME_LIGHT_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH || 'https://cdn.jsdelivr.net/npm/prism-themes@1.9.0/themes/prism-one-light.min.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://cdn.jsdelivr.net/npm/prism-themes@1.9.0/themes/prism-one-dark.min.css', // 深色模式主题
